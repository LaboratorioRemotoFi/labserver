...
var _practice = _interopRequireDefault(require("./practice/practice.js"));
...
var practice = new _practice["default"]();
practice.init();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (connections.length > 1) {
              console.log("connection rejected: can't have more than one connection at the same time");
              socket.emit("setup", {
                status: "error",
            ...
            socket.on("setup", function (data) {
              if (data.user === "admin" && data.password === "admin") {
                try {
                  var doc = _jsYaml["default"].load(_fs["default"].readFileSync(_path["default"].join(__dirname, "./practice/metadata.yml"), "utf-8"));
            ...
            socket.on("command", function (command, value) {
              console.log("Command received", {
                command: command,
                value: value
              });
              var result = practice.command(command, value);
